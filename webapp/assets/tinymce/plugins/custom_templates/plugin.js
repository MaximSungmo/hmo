...
tinymce.PluginManager.add('custom_templates', function(editor) {
	...
	editor.addButton('custom_templates', {
		title: 'Insert Custom template',
		onclick: createTemplateList(showDialog)
	});

	editor.addMenuItem('custom_templates', {
		text: 'Insert Custom template',
		onclick: createTemplateList(showDialog),
		context: 'insert'
	});
