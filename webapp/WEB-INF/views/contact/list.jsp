...
<c:import url="/WEB-INF/views/common/head.jsp">
	<c:param name="title">주소록</c:param>
	...
	<div id="rw-snn-main" class="rw-snn">
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<c:set var="breadcrumbs" value="주소록" scope="request" />
				<c:set var="breadcrumbLinks" value="/contact" scope="request" />
				...
				<div class="page-content">
					<div class="rw-content-area-wrap">
						<div class="rw-content-area">
							...
							<div class="rw-pagelet-wrap">
								<div class="lighter blue">
									<ul class="nav nav-pills">
										<li class="active"><a href="/contact">전체보기</a></li>
										<li><a href="/contact/groups">그룹</a></li>
										<li><a href="/contact/favorites">즐겨찾기</a></li>
										<li class="pull-right">
										<a href="#" id="toggle-detail-search">
											상세검색 </a>
										</li>
									</ul>
									<!-- 										<span > -->
								...
								<div id="detail-select">
									<div class="accordion-body collapse" >
										<div class="accordion-inner">
											<div class="z1">
												<small  class="pull-left" style="display: inline-block; width: 60px;">검색기준 : </small><br />
												<label class="pull-left">
													<input type="radio" name="qt" class="ace more-detail" value="0" checked data-name="qt" data-value="0">
													<span class="lbl">이름</span>	
												</label>
												<label class="pull-left">
													<input type="radio" name="qt" class="ace more-detail" value="1" data-name="qt" data-value="1">
													<span class="lbl">이메일</span>	
												</label>
												<label class="pull-left">
													<input type="radio" name="qt" class="ace more-detail" value="2" data-name="qt" data-value="2">
													<span class="lbl">직책</span>	
												</label>
											</div>
											<div class="z1">
												<small  class="pull-left" style="display: inline-block; width: 60px;">필터 적용 :</small> <br />
											...
											<%--
											<div class="z1">
												<small class="pull-left" style="display: inline-block; width: 60px;">정렬 : </small><br />
												<label class="pull-left">
							...
							<div id="contact-list">
								<c:import url="/WEB-INF/views/contact/pagelet/list.jsp"></c:import>
							</div>
						</div>
					</div>
...
// 	}
	...
	function show_profile(elem){
		...
		_$ejs_show_profile = new EJS( {
			url: "/assets/sunny/2.0/js/template/show-profile.ejs?v=1.1"
		});
		}
	...
	$(function() {
		...
		$(document.body).onHMOClick("#toggle-detail-search", function(e){
			e.preventDefault();
			if( $(this).hasClass("open") ){
				$("#detail-select .collapse").css("height", "0");	
				
			}else{
				$("#detail-select .collapse").css("height", "inherit");
			}
