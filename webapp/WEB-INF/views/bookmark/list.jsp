...
<c:import url="/WEB-INF/views/common/head.jsp">
	<c:param name="title">스크랩</c:param>
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="snn-sidebar">
				...
				<c:import url="/WEB-INF/views/common/nav-list.jsp">
					<c:param name="menuName">스크랩</c:param>
				</c:import>
				<!-- END:nav-list -->
			...
			<div class="main-content">
				...
				<c:set var="breadcrumbs" value="스크랩" scope="request" />
				<c:set var="breadcrumbLinks" value="/bookmark" scope="request" />
					...
					<div class="rw-content-area-wrap">
						<div class="rw-content-area">
							...
							<div id="bookmark-list-wrap" style="border-top: 1px solid lightgray; margin: 10px 10px 0 10px;">
								<c:import url="/WEB-INF/views/pagelet/bookmark/list.jsp"></c:import>
							</div>
						</div>
					</div>
