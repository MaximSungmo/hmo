								...
								<div class="rw-a-content">
									<div class='tabbable'>
										<ul class='nav nav-tabs padding-12 tab-color-blue' id=''>
											...
											<li>
												<a data-toggle="" href="/a/department/${smallGroup.id }/permitions">권한관리</a>
											</li>
										</ul>
									</div>							
													...
													<div class="span9">
														<div class="control-group">
															...
															<div class="controls">
																<div class="row-fluid">
																	<label>
																		<input type="radio" class="ace"  name="parentDepartmentRadio" value="1" ${ empty smallGroup.parent ? 'checked' : ' '}>
																		<span class="lbl">&nbsp;최상위 부서</span>
																	</label>
																	<div>	
																		<label style="float:left">
																			<input type="radio" class="ace" name="parentDepartmentRadio" value="2"  ${ not empty smallGroup.parent ? 'checked' : ' '}>
																			<span class="lbl">&nbsp;</span>
																		</label>
																		<input style="display:block;float:left" value="${not empty smallGroup.parent ? smallGroup.parent.name : ''}" type="text" name="departmentParentId" id="departmentParentId" placeholder="상위부서 이름을 검색하여 주세요.">
																	</div>
																</div>	
															</div>
														</div>	
															...
															<div class="controls">
																<div class="row-fluid">
																	<span class="span12 input-icon input-icon-right rw-input-wrap">
																		<input class="span12" type="text" name="departmentName" id="departmentName"  value="${smallGroup.name }" placeholder="이름">
														...
														<div class="control-group">
															...
															<div class="controls">
																<div class="row-fluid">
																	<span class="span12 input-icon input-icon-right rw-input-wrap">
																		<input class="span12" type="text" name="departmentDescription" id="departmentDescription"  value="${smallGroup.description }" placeholder="이름">
																		<i class="icon-remove-sign"></i>
																		<i class="icon-ok-sign"></i>
																	</span>
																</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																<select name="departmentStatus" id="departmentStatus" >
