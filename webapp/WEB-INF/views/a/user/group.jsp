	...
	$(document.body).on("change", ".group-select", function(e){
		...
		$.ajax({
			...
			success: function(data){
				...
				var html = '<div class="group-select-wrap"><select class="group-select " data-type="${param.sgtype}" data-sequence="' + ($this.data("sequence") + 1 ) + '" class="group-select">';
							...
							<div class="rw-pagelet-wrap rw-mtl">
								...
								<div class="rw-a-content z1" style="background-color: #FAFAFA; border: 1px solid #DDD; padding: 10px; ">
									<div class="group-select-wrap">
										<select id="select-group-0" data-sequence="0" data-type="${param.sgtype }" class="group-select" style="">
											<option value=""></option>
									...
									<div class="rw-a-content" style="clear:both; ">
										<a href="#" id="join-user-to-group" class="hmo-button hmo-button-blue">${user.name } 님을 선택된 그룹에 추가합니다.</a>							
									</div>
								</div>
								<div class="rw-a-content">
									<div class='tabbable'>
										<ul class='nav nav-tabs padding-12 tab-color-blue' id=''>
											...
											<li class="${param.sgtype == 5 ? 'active' : '' }">
