...
<c:import url="/WEB-INF/views/common/head.jsp">
	<c:param name="title">초대된 사용자들</c:param>
		...
		<div class="main-container container-fluid z1" id="main-container">
			...
			<div class="sidebar" id="snn-sidebar">
				...
				<c:import url="/WEB-INF/views/common/nav-list-a.jsp">
					<c:param name="menuName">초대</c:param>
				</c:import>			
				<!-- END:nav-list -->
			...
			<div class="main-content z1">
				...
				<c:set var="breadcrumbs" value="관리자콘솔,초대된사용자들" />
				<c:set var="breadcrumbLinks" value="/a,/a/site/invite_users" />
...
<%-- 									<li class="active"><a href="/a/site/inactive_users" class="btn btn-info" ><i class="fa fa-user"></i>&nbsp;미승인목록</a></li> --%>
<%-- 									<li class=""><a href="/a/site/sent_users" class="btn btn-info" >&nbsp;사용자미인증목록</a></li> --%>
<%-- 									<li class=""><a href="/a/site/deny_users" class="btn btn-info" >&nbsp;거부목록</a></li> --%>
<!-- 								</ul> -->
<!-- 							</div> -->
<!-- 						</div> -->
						<div class="rw-pagelet-wrap rw-mtl">
							...
							<div id="pagelet-changeable-list">
								<c:import url="/WEB-INF/views/pagelet/a/site/invite_users.jsp"></c:import>
							</div>
						</div>
					</div>
				</div>
...
function deny_inactive_user(data){
	...
	window.location.href="/a/site/invite_users";
}

function resend_invite_email(data){
	if( data.result == "fail"){
		MessageBox(data.message, data.message, MB_ERROR);
		return false;
	}
	MessageBox("다시 초대하기", "초대 메일이 재전송되었습니다.", MB_INFORMATION);
}
