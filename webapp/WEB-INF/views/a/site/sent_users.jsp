						...
						<div class="rw-pagelet-wrap rw-mtl">
							<div class="lighter blue">
								<ul class="nav nav-tabs">
									<li class=""><a href="/a/site/inactive_users">미승인목록</a></li>
									<li class="active"><a href="/a/site/sent_users">사용자미인증목록</a></li>
								</ul>
							</div>
						</div>
						<div class="rw-pagelet-wrap">
							<div id="pagelet-changeable-list">
								<c:import url="/WEB-INF/views/pagelet/a/site/sent_users.jsp"></c:import>
							</div>
						</div>
					</div>
				</div>
...
function deny_inactive_user(data){
	...
	window.location.href="/a/site/sent_users";
}
