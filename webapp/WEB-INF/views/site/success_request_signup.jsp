				...
				<div class="row-fluid rw-signup-wizard-content-row-fluid">
					<div class="span12">
						<div class="site-list-wrap">
							<div class="site-list-img">
								<img src="/assets/sunny/2.0/img/hellomyoffice_logo.png" alt="hellomyoffice-logo">
							</div>
							<div class="exception-main-title">
							<h2>회원가입이 완료되었습니다.</h2>
							<p class="exception-main-title-p"><span class="exception-main-title-sp">
							이제 <strong>'Hello my office'</strong>를 통해 활기찬 기업 문화를 만들어 보세요.
							</span>
							</p>
							<a href="/user/logout" class="hmo-button hmo-button-blue hmo-button-large-10">메인화면 바로가기</a>
							</div>
						</div>
					</div>
				</div>
