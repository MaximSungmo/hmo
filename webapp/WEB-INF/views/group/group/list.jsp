...
<c:import url="/WEB-INF/views/common/head.jsp">
	<c:param name="title">모든 소그룹 보기</c:param>
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="snn-sidebar">
				...
				<c:import url="/WEB-INF/views/common/nav-list.jsp">
					<c:param name="menuName">소그룹</c:param>
				</c:import>
				<!-- END:nav-list -->
			...
			<div class="main-content">
				...
				<c:set var="breadcrumbs" value="소그룹 보기" scope="request" />
				<c:set var="breadcrumbLinks" value="/group" scope="request" />
							...
							<div class="rw-pagelet-wrap">
								<div class="lighter blue">
									<ul class="nav nav-pills">
										<li class="${empty param.tab || param.tab == 'all' ? 'active' : ''}"><a href="/group">전체 소그룹</a></li>
										<li class="${param.tab == 'my' ? 'active' : ''}"><a href="/group?tab=my">나의 소그룹</a></li>
										<li class="pull-right"><a href="#" onclick="return create_group();">소그룹 만들기</a></li>
									</ul>
								</div>
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
						<label class="control-label" for="groupName">소그룹 이름</label>
						<div class="controls">
							<div class="row-fluid">
								<span class="span12 input-icon input-icon-right rw-input-wrap">
									<input class="span12" type="text" name="name" id="groupName" placeholder="소그룹 이름을 넣어주세요">
					...
					<div class="control-group">
						<label class="control-label" for="groupDescription">소그룹 설명</label>
						<div class="controls">
							<div class="row-fluid">
								<textarea class="span12" name="description" id="groupDescription" placeholder="소그룹 설명을 넣어주세요."></textarea>
							</div>
						</div>
					</div>		
				</div>
