...
<h3> 야캠프 CDN 서비스 </h3>
<p>
	 스토리 업로드 ( 리사이징 / 크롭 기능 포함  )<br/>
	<a href="<c:url value='/upload/story'/>">업로드 하기</a> <br/><br/>
	<form id="form-upload" action="<c:url value='/upload/story'/>" enctype="multipart/form-data" method="post" target="upload_target">
