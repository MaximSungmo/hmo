	...
	<div data-id="" class="row-triple list-border-bottom" >
		...
		<div class="triple-second">
			<div class="triple-cell">
				...
				<div>
					<a href="/a/site/deny" ajaxify="deny_inactive_user" data-request-map='{"id":"${siteInactiveUser.id}"}' rel="async-get" class="hmo-button hmo-button-white hmo-button-small-6">삭제</a>
					<a href="#" class="hmo-button hmo-button-blue hmo-button-small-6">메일 재전송</a>
				</div>
			</div>
		</div>
