...
$(function() {
	...
	$(".request-friend").onHMOClick( null, function(e){
				...
				<div class="page-content z1">
					<div class="rw-content-area-wrap">
						<div class="rw-content-area">
							<div class="rw-pagelet-wrap rw-mtl">
								<div class="row-fluid">
									<div class="span3 center">
										...
										<h4 class="inline">
											<span  id="basecamp-name" data-name="name" data-class="name-${basecampUser.id }" class="${myBasecamp || authUserIsAdmin ? 'basecamp-editable' : ''} middle name-${basecampUser.id }">${basecampUser.name }</span>
										</h4>
										<div class="inline position-relative">
											...
											<c:if test="${myBasecamp || authUserIsAdmin }">
										...
										<c:if test="${basecampUser.id != authUserId }">
											<a href="#" id="basecamp-message" class="basecamp-hmo-button hmo-button-white basecamp-hmo-button-request hmo-btn-block">
												...
												<a href="#" id="request-friend-${basecampUser.id }-t1" data-uid="${basecampUser.id }" data-type="1" class="request-friend basecamp-hmo-button hmo-button-blue basecamp-hmo-button-request hmo-btn-block hidden-elem ${basecampUser.relationFriendRequest != 1 ? 'hidden-elem' : ''}">
													
													친구요청 취소
												</a>
												<a href="#" id="request-friend-${basecampUser.id }-t2" data-uid="${basecampUser.id }" data-type="2" class="request-friend basecamp-hmo-button hmo-button-blue basecamp-hmo-button-request hmo-btn-block hidden-elem ${basecampUser.relationFriendRequest != 2 ? 'hidden-elem' : ''}">
													
													친구요청 수락
												</a>
												<a href="#" id="request-friend-${basecampUser.id }-t3" data-uid="${basecampUser.id }" data-type="3" class="request-friend basecamp-hmo-button hmo-button-blue basecamp-hmo-button-request hmo-btn-block hidden-elem ${basecampUser.relationFriendRequest != 3 ? 'hidden-elem' : ''}">
									...
									<div class="span9">
										<div class="profile-user-info">
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span data-name="email" data-type="email" class="${myBasecamp || authUserIsAdmin ? 'basecamp-editable' : ''} email-${basecampUser.id }" data-class="email-${basecampUser.id }" id="basecamp-email">${basecampUser.email }</span>
												</div>
											</div>
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span data-name="phone" class="${myBasecamp || authUserIsAdmin ? 'basecamp-editable' : ''} phone-${basecampUser.id }" data-class="phone-${basecampUser.id }" id="basecamp-phone">${basecampUser.phone }</span>
												</div>
											</div>
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span data-name="innercall" class="${myBasecamp || authUserIsAdmin ? 'basecamp-editable' : ''} innercall-${basecampUser.id }" id="basecamp-innercall" data-class="innercall-${basecampUser.id }">${basecampUser.innercall }</span>
												</div>
											</div>
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<span data-name="statusMessage" class="${myBasecamp || authUserIsAdmin ? 'basecamp-editable' : ''} statusMessage-${basecampUser.id }" data-class="statusMessage-${basecampUser.id }" id="basecamp-statusMessage">${basecampUser.statusMessage }</span>
												</div>
											</div>
							...
							<div class="rw-pagelet-wrap rw-mtl">
								<div class="center">
									<a href="/user/${basecampUser.id}">
									<span class="btn btn-app btn-small btn-yellow no-hover">
										<span class="bigger-175"> ${basecampUser.info.friendCount } </span>
		
										<br>
										<span class="smaller-90"> 친구들 </span>
									</span>	
									</a>
									<span class="btn btn-app btn-small btn-grey no-hover">
										<span class="bigger-175"> X </span>
		
										<br>
										<span class="smaller-90"> 그룹들 </span>
									</span>					
									<span class="btn btn-app btn-small btn-pink no-hover">
										<span class="bigger-175"> X </span>
		
										<br>
										<span class="smaller-90"> 프로젝트 </span>
									</span>
									<c:if test="${myBasecamp }">
										<a href="/user/${basecampUser.id}/setting">
											<span class="btn btn-app btn-small btn-pink no-hover">
												<span class="bigger-175"> 설정 </span>
				
												<br>
												<span class="smaller-90"> 설정 </span>
											</span>
										</a>
									</c:if>
								</div>
							...
							<div class="rw-pagelet-wrap">
								...
								<div id="list-changeable">
									<c:import url="/WEB-INF/views/pagelet/user/friends.jsp"></c:import>
								</div>
...
<script>
function ajax_follow(data){
	
	$(this).addClass("hidden-elem");
	$(this).siblings("[data-follow-action]").removeClass("hidden-elem");
