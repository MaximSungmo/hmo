...
public class ContentDTO {
	...
	private List<SmallGroupApproval> approbators;
	
	private List<SmallGroupApproval> cooperations;
	
	private SmallGroupApproval smallGroupApproval;
...
//	}
	...
	public Long getSmallGroupName() {
		return smallGroupName;
	}


	public void setSmallGroupName(Long smallGroupName) {
	...
	public SmallGroupApproval getSmallGroupApproval() {
		return smallGroupApproval;
	}


	public void setSmallGroupApproval(SmallGroupApproval smallGroupApproval) {
		this.smallGroupApproval = smallGroupApproval;
	}


	public List<SmallGroupApproval> getApprobators() {
		return approbators;
	}


	public void setApprobators(List<SmallGroupApproval> approbators) {
		this.approbators = approbators;
	}


	public List<SmallGroupApproval> getCooperations() {
		return cooperations;
	}


	public void setCooperations(List<SmallGroupApproval> cooperations) {
