...
import kr.co.sunnyvale.sunny.domain.extend.DummySerializable;
...
public class CustomHttpSessionSecurityContextRepository implements SecurityContextRepository {
    ...
    public void saveContext(SecurityContext context, HttpServletRequest request, HttpServletResponse response) {
        CustomSaveContextOnUpdateOrErrorResponseWrapper responseWrapper = (CustomSaveContextOnUpdateOrErrorResponseWrapper)response;
     ...
     */
    final class SaveToSessionResponseWrapper extends CustomSaveContextOnUpdateOrErrorResponseWrapper {
        ...
        protected void saveContext(SecurityContext context) {
            ...
            if (httpSession != null) {
                ...
                if (contextChanged(context) || httpSession.getAttribute(springSecurityContextKey) == null) {
                    ...
                    /**
                     * 이상하게 serializable 한 것이 안들어가면 context 가 update 되지 않는다..
                     * 도저히 못찾겠어서 dummy 하나 넣어줌. 소발에 쥐잡기임
                     */
                    DummySerializable dummy = new DummySerializable();
                    httpSession.setAttribute("a", dummy);
